          ...
          switch (value.op) {
            ...
            case 'between':
              if (!value.secondValue) {
                throw new Error(
                  `Because between op code was passed in, keyValue: ${keyValue[0]} must have both also include a secondValue`,
                );
              }
              if (
                typeof value.secondValue !== 'string' &&
                typeof value.secondValue !== 'boolean' &&
                typeof value.secondValue !== 'number'
              ) {
            ...
            case 'notBetween':
              if (!value.secondValue) {
                throw new Error(
                  `Because notBetween op code was passed in, keyValue: ${keyValue[0]} must have both also include a secondValue`,
                );
              }
              if (
                typeof value.secondValue !== 'string' &&
